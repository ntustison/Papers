...
\vspace{2mm}
  ...
  \begin{center}
  {\normalsize \bf Open source software} \\
{\vspace{3mm}}
  \begin{tabular}{cc}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \scriptsize
  \begin{itemize}
  \item Partial funding support from NZ Breacher study
  \item This project is also funded, in part, under a grant with the Pennsylvania 
  Department of Health. The Department specifically disclaims responsibility 
