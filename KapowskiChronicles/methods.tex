...
well for our processing and are used to acquire the results 
...
within each label using only the non-zero voxels from the cortical thickness map.
...
Several subjects were removed after cortical thickness map calculation during 
the post-analysis 
since certain
demographic information was missing preventing an accurate estimate of 
