...
\address[label3]{Department of Circulation and Medical Imaging,
  ...
  Norway---\textcolor{blue}{should be netherlands not sure of specifics}}
...
(ANT\textcolor{blue}{s}) cortical thickness automated pipeline
...
all developed as part of the ANT\textcolor{blue}{s} open science effort.  
Complementing the open source aspect of ANT\textcolor{blue}{s} we confirm 
