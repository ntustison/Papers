...
Four open data sets (IXI, Kirby, NKI, and Oasis), comprising approximately 
1200 subjects, were processed using the proposed pipeline.  Reproducibility scores
from a subset of these data, along with a complementary age prediction
evaluation, demonstrate robust performance.  Additionally, we present novel
