...
Complementing the open source aspect of ANTs we investigate several hypotheses
explored previously in the literature using four different publicly 
available data sets totaling approximately 1200 subjects.  
...
\section{Comments from Brian}
\begin{itemize}
  \item contributions
  \begin{itemize}
    \item establish population variability internationally ... reference thickness values .... i.e. look up table for thickness results ....
    \item 7 sites 
    \item report novel gender diff over age 
    \item play up large - scale reliability  multisite 
    \item largest N on public multisite data?  reference peele ...
    \item quantify site effect .... is it low?
    \item allows us to quantify gender differences over a large age range ....
  \end{itemize}
  \item misc.
    \begin{itemize}
      \item figures  
      \item ask peele for feedback?
      \item questions - can we get by on large N and multisite alone 
      \item do we need to establish that we are more reliable than FSurf or FSL or SPM?
      \item we set the bar high by doing X number of images
      \item \sout{in discussion, say that future work will quantify SPM ....  not nec. by us.} 
    \end{itemize}
\end{itemize}    
