...
i.e. specifically that ``improvement of performance in problem-solving hinges on using prior information to match procedures to problems.''  One should keep this in
mind when following the next guideline.  
