...
or clarify documentation.
  ...
  \item
    \textcolor{blue}{\href{http://en.wikipedia.org/wiki/Accuracy_and_precision}{Accuracy
        and precision (link)}} --- most studies ignore precision.  it
  ...
  \item Prediction---an algorithm that yields a ``more significant''
    ...
    areas'' or smaller p-values.  Testing prediction is complements
