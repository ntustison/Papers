...
outcome by using open data in normal controls from the International
...
Normalization (also known as image registration) maps each image in the population to a common coordinate system thus enabling statistical comparison across patient groups or association with other variables such as genetics, cognition or age.  
