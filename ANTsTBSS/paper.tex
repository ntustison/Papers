...
\title{On Population-Based FA Analysis with Non-independent Normalization and Statistics}
...
To illustrate the effect of similarity metric on statistical significance, we performed ANTs registration \cite{Avants2011} of each subject to the template
...
alignment (e.g. \cite{Klein2009}).  All of this work, though, compares
...
anatomical alignment.  Rather, it is a result of
...
of normalization/statistical non-independence.  Similar issues are
...
our results' biological plausibility, nor do we
...
Rather, we focus on the technical issue of circularity induced by
...
invalidates previous results that used a circular strategy.  Instead, we encourage the community to
...
statistical techniques (via {\bf R}), normalization methods (ANTs) and
