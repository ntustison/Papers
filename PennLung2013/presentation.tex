...
\title[Advances in Pulmonary Registration]{Advances in Pulmonary Image Registration}
\author[N. Tustison]{%
  N. J. Tustison
  }
\date[Pulmonary Imaging Workshop]{}
...
\begin{frame}{Nuances of pulmonary image registration}
...
\begin{center}
  \begin{itemize}
    \item Anatomy
      \begin{itemize}
        \item sliding interface lung/chest wall
        \item discontinuous lobes
        \item tubular blood vessels
        \item branching airways
      \end{itemize}  
    \item Modality
      \begin{itemize}
        \item CT
        \item $^1$H MRI
        \item hyperpolarized gas MRI
      \end{itemize}
    \item Application
      \begin{itemize}
        \item kinematics
        \item radiotherapy treatment planning
        \item treatment characterization
      \end{itemize}  
  \end{itemize}
\end{center}
\end{column}
...
\begin{column}{0.45\textwidth}
\begin{center}
  \includegraphics[width=5cm]{Gray490.png}
\end{center}
\end{column}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Lung-specific approaches
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}{Lung-specific approaches}
  \begin{itemize}
    \item Features
      \begin{itemize}
         \item landmarks
         ...
         \item currents
      \end{itemize}
    \item Sliding conditions
      \begin{itemize}
        \item Multiple B-splines
        \item Piecewise diffeomorphisms
      \end{itemize}  
    \item Customized FEM models
  \end{itemize}
  
\begin{picture}(0,0)
  \put(200,80)
    {\includegraphics[width=20mm]{inspiration.pdf}}
\end{picture}
\begin{picture}(0,0)
  \put(260,81)
    {\includegraphics[width=20mm]{expiration.pdf}}
\end{picture}
\begin{picture}(0,0)
  \put(220,10)
    {\includegraphics[width=25mm]{Fem.png}}
\end{picture}

\begin{picture}(0,0)
  \put(200,-45)
    {\includegraphics[width=40mm]{Risser.png}}
\end{picture}
...
{
\usebackgroundtemplate{\includegraphics[width=1.175\paperwidth]{geek-flip_geek-fight-club_1.jpg}}%
\begin{frame}{EMPIRE10 Challenge}
...
\begin{itemize}
  \item 31 competitors
  \item Pre-competition: 20 scan pairs
  \item On-site:  10 scan pairs
  \item Evaluation criteria:
    \begin{itemize}
      \item lung boundary alignment,
      \item fissure correspondence,
      \item landmark distance, and
...
\begin{column}{0.45\textwidth}
\begin{itemize}
  \item Top current competitors:
    \begin{itemize}
      \item picsl gsyn                % generic approach
      \item CMS                       % Xiao Han == a global rigid registration, feature point (detection 384 feature vector with nearest neighbor matching) + mutual-information (MI) deformable registration, and finally another dense deformable registration to further refine the results  
      \item MetaReg (ANTSNifElx)     % Image Sciences Institute, B-spline weighted average of ANTs/NiftyReg/Elastix
      \item MIC + Fraunhoer MEVIS L\"ubeck % Explicit boundary-matching term, ensures no folding
      \item ISI@UMCU % diff. demons with spatially varying regularization
      \item MetaReg (NifElx) 
      \item Nifty Reggers  % FFD on the GPU
      \item elastix\_smooth  %Ultrecht
      \item IMI L\"ubeck Diffeomorph  % surface registration -> diff registration
    \end{itemize}
\end{itemize}
\end{column}
...
\begin{block}{}
  \begin{center}
  \tiny
  K. Murphy et al., {\it Evaluation of registration methods on thoracic CT:  The EMPIRE10 Challenge},
    IEEE Trans Med Imaging 30(11):1901--1920 (2011).
  \end{center}
\end{block}
...
{
\usebackgroundtemplate{\begin{picture}(0,0)\put(-75,-310)
{\includegraphics[width=1.4\paperwidth]{FBI_Laboratory_scientist.jpg}}\end{picture}}
\begin{frame}[t]{Open science}


ITKv4 registration

\begin{itemize}
  \item Based on our experience with ANTS
  \item Advanced transforms
  \item Point set metrics for hybrid formulations
  \item Program in ANTs (antsRegistration)
\end{itemize}
...
{
\usebackgroundtemplate{\begin{picture}(0,0)\put(-75,-310)
{\includegraphics[width=1.4\paperwidth]{3Dlungs.png}}\end{picture}}
...
OPTIONS: 
     ...
     -q, --initial-fixed-transform initialTransform
                                   ...
                                   [fixedImage,movingImage,useCenterOfMass]
     ...
     -m, --metric CC[fixedImage,movingImage,metricWeight,radius,...]
                  ...
                  MeanSquares[fixedImage,movingImage,metricWeight,...]
                  Demons[fixedImage,movingImage,metricWeight,...]
                  GC[fixedImage,movingImage,metricWeight,...]

\end{lstlisting}                 
\end{frame}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  antsRegistration (cont.)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%        caption={Representative script used for the LPBA40 evaluation.},
        captionpos=b,
        label=listing:script2
        }

\begin{frame}[fragile]
\frametitle{antsRegistration (cont.)}
\begin{lstlisting}
     -t, --transform Rigid[gradientStep]
                     ...
                     GaussianDisplacementField[gradientStep,updateFieldVarianceInVoxelSpace,...]
                     ...
                     Exponential[gradientStep,updateFieldVarianceInVoxelSpace,...]
...
\begin{figure}
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fixed_170.png}
   \end{subfigure}
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{moving_170.png}
   \end{subfigure}
  \pause
  \vspace{0.05cm} 
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{moving_warped_170.png}
   \end{subfigure}
  \begin{subfigure}[b]{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{fixed_warped_grid_170.png}
   \end{subfigure}
%   \,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,\,
\end{figure}
\end{column}
...
${ANTsPATH}antsRegistration -d 3 \
  ...
  -f 8x4x2x1 \
  -s 3x2x1x0 \
  -c [500x200x100x20,1e-6,10] \
  -m CC[${fixed},${moving1},1,4] \
  -m MSQ[${fixedDist},${moving1Dist},0.1] \
  -t BSplineSyN[0.1,10x10x11,0x0x0] \
  -f 6x4x2x1 \
  -s 3x2x1x0 \
  -c [70x50x40x10,1e-8,10] \
  -o ${fixedPrefix}x${moving1Prefix}_
\end{lstlisting}     
\end{column}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%  What about advanced applications?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
   ...
   \begin{block}
      \Large
      N. J. Tustison, et al.  ``Voxel-Based Longitudinal Analysis of Pulmonary Ventilation MRI''
   \end{block}
...
%   \draw[->, >=latex, blue!20!white, line width=72pt] (4, 16) Ñ node [black,sloped]            {Optimization} +(-45:17cm);			
